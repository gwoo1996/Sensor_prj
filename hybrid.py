...
class VanillaRNN(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, sequence_length, num_layers, device):
        ...
        self.test1 = nn.Linear(hidden_size * sequence_length, 8)
        self.test2 = nn.Linear(8, 12)
        self.test3 = nn.Linear(12, 24)
        self.test4 = nn.Linear(24, 12)
        self.test5 = nn.Linear(12, 4)
        self.testfc = nn.Linear(4, 1)
        self.relu = nn.ReLU()
...
def plotting(train_loader, test_loader, actual):
    ...
    data_for_plot.to_csv("../sprj/hybrid_CO.csv")
